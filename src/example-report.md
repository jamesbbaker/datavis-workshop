...
h2 {
  ...
  text-shadow: 0 1px 0 color-mix(in srgb, var(--theme-foreground) 25%, transparent);
}
...
h3 {
  ...
  font-size: 1.1rem;
  font-weight: 650;
  border-left: 3px solid var(--theme-foreground-muted);
  padding-left: 0.6rem;
}
...
> **Note:** This page demonstrates custom heading styles, inline spans, and the timeline component from the tutorial exercises.

## Background

The history of rocket launches dates back to ancient China, where gunpowder-filled tubes were used as primitive forms of propulsion. Lorem ipsum <span style="background: linear-gradient(transparent, cyan)">dolor sit amet</span>, consectetur <span class="essential">adipiscing</span> elit — a tiny nod to the styling exercises.
